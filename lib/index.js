(function (global, factory) {
    ...
    /* src/Svrollbar.svelte generated by Svelte v3.35.0 */

    const { document: document_1 } = globals;

    function add_css$1() {
    	var style = element("style");
    	style.id = "svelte-iodyq2-style";
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			set_style(div1, "height", /*thumbHeight*/ ctx[7] + "px");
    		...
    		p(ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*thumbHeight*/ 128) {
    				set_style(div1, "height", /*thumbHeight*/ ctx[7] + "px");
    			}
     ...
     */
    	...
    	function setupTimer() {
    		timer = window.setTimeout(
    			() => {
    				$$invalidate(8, visible = alwaysVisible || false);
    				dispatch("hide");
    			},
    			hideAfter
    		);
    	...
    	function onScroll() {
    		clearTimer();
    		setupTimer();
    		$$invalidate(8, visible = alwaysVisible || true);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*trackHeight, wholeHeight*/ 32832) {
    			$$invalidate(7, thumbHeight = trackHeight / wholeHeight * trackHeight ?? 0);
    		}
    		...
    		if ($$self.$$.dirty[0] & /*wholeHeight, trackHeight, thumbHeight*/ 32960) {
    ...
    class Svrollbar extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document_1.getElementById("svelte-iodyq2-style")) add_css$1();
    ...
    /* src/Svroller.svelte generated by Svelte v3.35.0 */

    function add_css() {
    	var style = element("style");
    	style.id = "svelte-2auii3-style";
    	style.textContent = ".svlr-wrapper.svelte-2auii3{position:relative}.svlr-viewport.svelte-2auii3{position:relative;overflow:scroll;box-sizing:border-box;-ms-overflow-style:none;scrollbar-width:none}.svlr-viewport.svelte-2auii3::-webkit-scrollbar{display:none}";
    ...
    class Svroller extends SvelteComponent {
    	constructor(options) {
    		super();
    		if (!document.getElementById("svelte-2auii3-style")) add_css();
