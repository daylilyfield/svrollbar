(function (global, factory) {
    ...
    function create_if_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			toggle_class(div2, "fixed", /*windowScrollEnabled*/ ctx[7]);
    		},
    		m(target, anchor) {
    		...
    		p(ctx, dirty) {
    			...
    			if (dirty[0] & /*windowScrollEnabled*/ 128) {
    				toggle_class(div2, "fixed", /*windowScrollEnabled*/ ctx[7]);
    			}
    		},
    		i(local) {
     ...
     */
    	...
    	function setupViewport(viewport) {
    		...
    		$$invalidate(7, windowScrollEnabled = document.scrollingElement === viewport);
    	...
    	function setupTimer() {
    		timer = window.setTimeout(
    			() => {
    				$$invalidate(8, visible = alwaysVisible || initiallyVisible && !interacted && scrollable || false);
    				dispatch('hide');
    			},
    			hideAfter
    		);
    	...
    	function onScroll() {
    		clearTimer();
    		setupTimer();
    		$$invalidate(8, visible = alwaysVisible || initiallyVisible && !interacted && scrollable || true);
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('initiallyVisible' in $$props) $$invalidate(15, initiallyVisible = $$props.initiallyVisible);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*wholeHeight, trackHeight*/ 65600) {
    			$$invalidate(18, scrollable = wholeHeight > trackHeight);
    		}

    		if ($$self.$$.dirty[0] & /*alwaysVisible, initiallyVisible, scrollable*/ 311296) {
    			$$invalidate(8, visible = alwaysVisible || initiallyVisible && scrollable);
    		}
    	};
    ...
    function create_fragment(ctx) {
    	...
    	svrollbar = new Svrollbar({
    			props: {
    				viewport: /*viewport*/ ctx[9],
    				contents: /*contents*/ ctx[10],
    				hideAfter: /*hideAfter*/ ctx[2],
    				alwaysVisible: /*alwaysVisible*/ ctx[3],
    				initiallyVisible: /*initiallyVisible*/ ctx[4],
    				vTrackIn: /*vTrackIn*/ ctx[5],
    				vTrackOut: /*vTrackOut*/ ctx[6],
    				vThumbIn: /*vThumbIn*/ ctx[7],
    				vThumbOut: /*vThumbOut*/ ctx[8]
    			}
    		});

    	svrollbar.$on("show", /*show_handler*/ ctx[15]);
    	svrollbar.$on("hide", /*hide_handler*/ ctx[16]);
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			...
    			if (dirty & /*viewport*/ 512) svrollbar_changes.viewport = /*viewport*/ ctx[9];
    			if (dirty & /*contents*/ 1024) svrollbar_changes.contents = /*contents*/ ctx[10];
    			...
    			if (dirty & /*vTrackIn*/ 32) svrollbar_changes.vTrackIn = /*vTrackIn*/ ctx[5];
    			if (dirty & /*vTrackOut*/ 64) svrollbar_changes.vTrackOut = /*vTrackOut*/ ctx[6];
    			if (dirty & /*vThumbIn*/ 128) svrollbar_changes.vThumbIn = /*vThumbIn*/ ctx[7];
    			if (dirty & /*vThumbOut*/ 256) svrollbar_changes.vThumbOut = /*vThumbOut*/ ctx[8];
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$$set = $$props => {
    		...
    		if ('vTrackIn' in $$props) $$invalidate(5, vTrackIn = $$props.vTrackIn);
    		if ('vTrackOut' in $$props) $$invalidate(6, vTrackOut = $$props.vTrackOut);
    		if ('vThumbIn' in $$props) $$invalidate(7, vThumbIn = $$props.vThumbIn);
    		if ('vThumbOut' in $$props) $$invalidate(8, vThumbOut = $$props.vThumbOut);
