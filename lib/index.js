     ...
     */
    	...
    	function setupTimer() {
    		timer = window.setTimeout(
    			() => {
    				$$invalidate(8, visible = scrollable && (alwaysVisible || initiallyVisible && !interacted) || false);
    				dispatch('hide');
    			},
    			hideAfter
    		);
    	...
    	function onScroll() {
    		...
    		clearTimer();
    		setupTimer();
    		$$invalidate(8, visible = alwaysVisible || initiallyVisible && !interacted || true);
    	...
    	$$self.$$.update = () => {
    		...
    		if ($$self.$$.dirty[0] & /*scrollable, alwaysVisible, initiallyVisible*/ 311296) {
    			$$invalidate(8, visible = scrollable && (alwaysVisible || initiallyVisible));
    		}
    	};
