...
function add_css$1() {
	...
	style.id = "svelte-1jc8axj-style";
	style.textContent = ".v-track.svelte-1jc8axj{position:absolute;top:0;right:0;border-radius:var(--svrollbar-track-radius, initial);width:var(--svrollbar-track-width, 10px);opacity:var(--svrollbar-track-opacity, 0);background-color:var(--svrollbar-track-color, initial)}.v-thumb.svelte-1jc8axj{position:relative;margin:0 auto;border-radius:var(--svrollbar-thumb-radius, 0.25rem);width:var(--svrollbar-thumb-width, 6px);opacity:var(--svrollbar-thumb-opacity, 0.5);background-color:var(--svrollbar-thumb-color, #454545)}";
...
function create_fragment$1(ctx) {
	...
	return {
		c() {
			div1 = element("div");
			div0 = element("div");
			attr(div0, "class", "v-thumb svelte-1jc8axj");
			set_style(div0, "height", /*thumbHeight*/ ctx[3] + "px");
			set_style(div0, "top", /*thumbTop*/ ctx[4] + "px");
			attr(div1, "class", "v-track svelte-1jc8axj");
...
function instance$1($$self, $$props, $$invalidate) {
	...
	let { viewport } = $$props;
	let { contents } = $$props;
	let { visibilityTimeout = 1000 } = $$props;
	let vTrack;
	let vThumb;
	const opacity = tweened(0, { duration: 300, easing: cubicOut });
	component_subscribe($$self, opacity, value => $$invalidate(5, $opacity = value));
	...
	function listen(viewport) {
		...
		const onScroll = () => {
			...
			setupTimer();
			opacity.set(1);
			$$invalidate(11, scrollTop = viewport?.scrollTop ?? 0);
		};
	...
	function observe(contents) {
		...
		const observer = new ResizeObserver(entries => {
				for (const _entry of entries) {
					$$invalidate(10, wholeHeight = viewport?.scrollHeight ?? 0);
				}
			});
	...
	$$self.$$set = $$props => {
		...
		if ("contents" in $$props) $$invalidate(8, contents = $$props.contents);
		if ("visibilityTimeout" in $$props) $$invalidate(9, visibilityTimeout = $$props.visibilityTimeout);
	};

	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*viewport*/ 128) {
			$$invalidate(10, wholeHeight = viewport?.scrollHeight ?? 0);
		}
		...
		if ($$self.$$.dirty & /*trackHeight, wholeHeight*/ 1025) {
			$$invalidate(3, thumbHeight = trackHeight / wholeHeight * trackHeight ?? 0);
		}

		if ($$self.$$.dirty & /*scrollTop, wholeHeight, trackHeight*/ 3073) {
			$$invalidate(4, thumbTop = scrollTop / wholeHeight * trackHeight ?? 0);
		}
...
class Svrollbar extends SvelteComponent {
	constructor(options) {
		super();
		if (!document_1.getElementById("svelte-1jc8axj-style")) add_css$1();
...
function create_fragment(ctx) {
	...
	svrollbar = new Svrollbar({
			props: {
				viewport: /*viewport*/ ctx[3],
				contents: /*contents*/ ctx[4],
				visibilityTimeout: /*visibilityTimeout*/ ctx[2]
			}
		});
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*viewport*/ 8) svrollbar_changes.viewport = /*viewport*/ ctx[3];
			if (dirty & /*contents*/ 16) svrollbar_changes.contents = /*contents*/ ctx[4];
			if (dirty & /*visibilityTimeout*/ 4) svrollbar_changes.visibilityTimeout = /*visibilityTimeout*/ ctx[2];
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ("visibilityTimeout" in $$props) $$invalidate(2, visibilityTimeout = $$props.visibilityTimeout);
