...
function add_css$1() {
	...
	style.id = "svelte-17l5i0w-style";
	style.textContent = ".v-scrollbar.svelte-17l5i0w{position:absolute;top:0;right:0;width:var(--svrollbar-track-width, 10px)}.v-track.svelte-17l5i0w{position:absolute;top:0;right:0;border-radius:var(--svrollbar-track-radius, initial);width:var(--svrollbar-track-width, 10px);opacity:var(--svrollbar-track-opacity, 1);background-color:var(--svrollbar-track-background, initial)}.v-thumb.svelte-17l5i0w{position:relative;margin:0 auto;border-radius:var(--svrollbar-thumb-radius, 0.25rem);width:var(--svrollbar-thumb-width, 6px);opacity:var(--svrollbar-thumb-opacity, 0.5);background-color:var(--svrollbar-thumb-background, gray)}";
 ...
 */
	...
	function setupContents(contents) {
		...
		const observer = new ResizeObserver(entries => {
				for (const _entry of entries) {
					$$invalidate(13, wholeHeight = viewport?.scrollHeight ?? 0);
				}
			});
	...
	function onScroll() {
		...
		$$invalidate(14, scrollTop = viewport?.scrollTop ?? 0);
		dispatch("show");
	}
	...
	$$self.$$.update = () => {
		...
		if ($$self.$$.dirty[0] & /*trackHeight, wholeHeight*/ 8256) {
			$$invalidate(8, thumbHeight = trackHeight / wholeHeight * trackHeight ?? 0);
		}

		if ($$self.$$.dirty[0] & /*scrollTop, wholeHeight, trackHeight*/ 24640) {
...
class Svrollbar extends SvelteComponent {
	constructor(options) {
		super();
		if (!document_1.getElementById("svelte-17l5i0w-style")) add_css$1();
...
function create_fragment(ctx) {
	...
	svrollbar = new Svrollbar({
			props: {
				viewport: /*viewport*/ ctx[7],
				contents: /*contents*/ ctx[8],
				hideAfter: /*hideAfter*/ ctx[2],
				vTrackIn: /*vTrackIn*/ ctx[3],
				vTrackOut: /*vTrackOut*/ ctx[4],
				vThumbIn: /*vThumbIn*/ ctx[5],
				vThumbOut: /*vThumbOut*/ ctx[6]
			}
		});

	svrollbar.$on("show", /*show_handler*/ ctx[13]);
	svrollbar.$on("hide", /*hide_handler*/ ctx[14]);
	...
	return {
		...
		p(ctx, [dirty]) {
			...
			if (dirty & /*viewport*/ 128) svrollbar_changes.viewport = /*viewport*/ ctx[7];
			if (dirty & /*contents*/ 256) svrollbar_changes.contents = /*contents*/ ctx[8];
			if (dirty & /*hideAfter*/ 4) svrollbar_changes.hideAfter = /*hideAfter*/ ctx[2];
			if (dirty & /*vTrackIn*/ 8) svrollbar_changes.vTrackIn = /*vTrackIn*/ ctx[3];
			if (dirty & /*vTrackOut*/ 16) svrollbar_changes.vTrackOut = /*vTrackOut*/ ctx[4];
			if (dirty & /*vThumbIn*/ 32) svrollbar_changes.vThumbIn = /*vThumbIn*/ ctx[5];
			if (dirty & /*vThumbOut*/ 64) svrollbar_changes.vThumbOut = /*vThumbOut*/ ctx[6];
...
function instance($$self, $$props, $$invalidate) {
	...
	$$self.$$set = $$props => {
		...
		if ("vTrackIn" in $$props) $$invalidate(3, vTrackIn = $$props.vTrackIn);
		if ("vTrackOut" in $$props) $$invalidate(4, vTrackOut = $$props.vTrackOut);
		if ("vThumbIn" in $$props) $$invalidate(5, vThumbIn = $$props.vThumbIn);
		if ("vThumbOut" in $$props) $$invalidate(6, vThumbOut = $$props.vThumbOut);
