...
function instance$1($$self, $$props, $$invalidate) {
	...
	function listen(viewport) {
		...
		const onScroll = () => {
			...
			$$invalidate(13, scrollTop = (_a = viewport === null || viewport === void 0
			? void 0
			: viewport.scrollTop) !== null && _a !== void 0
			? _a
			: 0);
		};
	...
	function observe(contents) {
		...
		const observer = new ResizeObserver(entries => {
				...
				for (const _entry of entries) {
					$$invalidate(12, wholeHeight = (_a = viewport === null || viewport === void 0
					? void 0
					: viewport.scrollHeight) !== null && _a !== void 0
					? _a
					: 0);
				}
			});
	...
	$$self.$$.update = () => {
		if ($$self.$$.dirty & /*viewport, _a*/ 160) {
			$$invalidate(12, wholeHeight = $$invalidate(7, _a = viewport === null || viewport === void 0
			? void 0
			: viewport.scrollHeight) !== null && _a !== void 0
			? _a
			: 0);
		...
		if ($$self.$$.dirty & /*viewport, _b*/ 288) {
			$$invalidate(13, scrollTop = $$invalidate(8, _b = viewport === null || viewport === void 0
			? void 0
			: viewport.scrollTop) !== null && _b !== void 0
			? _b
			: 0);
		}

		if ($$self.$$.dirty & /*viewport, _c*/ 544) {
			$$invalidate(0, trackHeight = $$invalidate(9, _c = viewport === null || viewport === void 0
			? void 0
			: viewport.offsetHeight) !== null && _c !== void 0
			? _c
			: 0);
		}

		if ($$self.$$.dirty & /*trackHeight, wholeHeight, _d*/ 5121) {
			$$invalidate(1, thumbHeight = $$invalidate(10, _d = trackHeight / wholeHeight * trackHeight) !== null && _d !== void 0
			? _d
			: 0);
		}

		if ($$self.$$.dirty & /*scrollTop, wholeHeight, trackHeight, _e*/ 14337) {
			$$invalidate(2, thumbTop = $$invalidate(11, _e = scrollTop / wholeHeight * trackHeight) !== null && _e !== void 0
			? _e
			: 0);
		}
